...
//go:noescape
func _or_avx512(out, v1, v2 unsafe.Pointer, size int)

//OrAVX512 applies AVX2 vectorized OR: v1 | v2 -> o
func (o Uint64s) OrAVX512(v1, v2 Uint64s) {
	_or_avx512(unsafe.Pointer(&o[0]), unsafe.Pointer(&v1[0]), unsafe.Pointer(&v2[0]), len(o))
}
...
//go:noescape
func _xor_avx512(out, v1, v2 unsafe.Pointer, size int)

//XorAVX512 applies AVX2 vectorized XOR: v1 ^ v2 -> o
func (o Uint64s) XorAVX512(v1, v2 Uint64s) {
	_xor_avx512(unsafe.Pointer(&o[0]), unsafe.Pointer(&v1[0]), unsafe.Pointer(&v2[0]), len(o))
}
